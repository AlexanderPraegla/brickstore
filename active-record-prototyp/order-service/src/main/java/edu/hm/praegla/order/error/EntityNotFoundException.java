...
public class EntityNotFoundException extends BrickstoreException {
    ...
    public EntityNotFoundException(Class<?> clazz, String key, Object value) {
        super(edu.hm.praegla.order.error.ResponseCode.ENTITY_NOT_FOUND, HttpStatus.NOT_FOUND, EntityNotFoundException.generateMessage(clazz.getSimpleName(), key, value));
    }
