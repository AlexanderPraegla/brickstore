...
@Slf4j
@Component
@RabbitListener(queues = MessagingRabbitMqConfig.SHOPPING_CART_SERVICE_QUEUE)
public class ShoppingCartMessageHandler {
    ...
    public ShoppingCartMessageHandler(ShoppingCartRepository shoppingCartRepository, ShoppingCartQueryService shoppingCartQueryService, SequenceGeneratorService sequenceGeneratorService) {
